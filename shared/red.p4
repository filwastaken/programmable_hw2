...
control MyIngress(inout headers hdr,
    ...
    action myTunnel_ingress(){
        ...
        if(ipv4.srcAddr == 1010000000000001 && ipv4.dstAddr == 1010000000000011) hdr.myTunnel.dst_id = 13;
        else if (ipv4.srcAddr == 1010000000000001 && ipv4.dstAddr == 1010000000000010) hdr.myTunnel.dst_id = 12;
    }
